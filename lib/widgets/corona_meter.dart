...
final worldProvider = FutureProvider.autoDispose((ref) => FetchData().getData());
final countryProvider = FutureProvider.family.autoDispose((ref, String con) => FetchData().getDatas(con));
...
class _CoronaMeterState extends State<CoronaMeter> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async{
        context.read(checkProvider.notifier).change();
                  ...
                  children: [
                    ...
                    Consumer(
                        builder: (context, watch, child) {
                          ...
                          final con = watch(
                              countryProvider(textController.text.trim()));
                          return Container(
